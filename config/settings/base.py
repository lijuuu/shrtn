...
SCYLLA_PARTITION_KEY_STRATEGY = env("SCYLLA_PARTITION_KEY_STRATEGY", default="composite")
SCYLLA_PARTITION_KEY_FIELDS = env("SCYLLA_PARTITION_KEY_FIELDS", default="namespace_id,shortcode")
SCYLLA_CLUSTERING_KEY_FIELDS = env("SCYLLA_CLUSTERING_KEY_FIELDS", default="id,created_at")
SCYLLA_CONSISTENCY_LEVEL = env("SCYLLA_CONSISTENCY_LEVEL", default="ONE")
SCYLLA_COMPRESSION = env("SCYLLA_COMPRESSION", default="LZ4Compressor")
...
ADMIN_SITE_TITLE = "Hirethon Admin Portal"
ADMIN_INDEX_TITLE = "Welcome to Hirethon Admin Portal"
